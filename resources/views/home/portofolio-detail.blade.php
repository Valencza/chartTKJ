            ...
            <div class="services-details-items">
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-7 pr-45 pr-md-15 pr-xs-15 services-single-content">
                        ...
                        <h2>{{$portofolioDetail->nama}}</h2>
                        <h5 class="mb-40">
                            {!! $portofolioDetail->deskripsi !!}
                        </h5>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-5 mt-md-50 mt-xs-50 pl-30 pl-md-15 pl-xs-15 services-sidebar">
                        ...
                        <div class="single-widget services-list-widget">
                            ...
                            <ul>
                                <li><b>Tanggal Proyek: </b>{{$portofolioDetail->tanggalProyek}}</li>
                                <li><b>Institusi Client: </b>{{$portofolioDetail->client}}</li>
                                <li><b>Lokasi: </b>{{$portofolioDetail->lokasi}}</li>
                            </ul>
                        </div>
                        <!-- End Single Widget -->
                    </div>
