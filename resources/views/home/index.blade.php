              ...
              <div class="row g-4">
                <div class="col-lg-4 col-md-6" data-aos-delay="50">
                  <div class="testimonial-item">
                    ...
                    <p>
                      ...
                      "Sistem POS ini sangat membantu dalam melacak progres pekerjaan perbaikan laptop dan HP, serta instalasi jaringan. Saya bisa lebih cepat dan efisien!"
                ...
                <div class="col-lg-4 col-md-6" data-aos-delay="200">
                  <div class="testimonial-item">
                    ...
                    <p>
                      <i class="bi bi-quote quote-icon-left"></i>
                      "POS ini sangat berguna untuk pembukuan pendapatan dari berbagai proyek, seperti perbaikan perangkat dan instalasi jaringan. Semua tercatat dengan baik."
                      <i class="bi bi-quote quote-icon-right"></i>
                    </p>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6" data-aos-delay="350">
                  <div class="testimonial-item">
                    <img src="{{asset ('assets/user/img/digireads-assets/jennie.jpeg') }}" class="testimonial-img" alt>
                    <h3>Jennie Ruby</h3>
                    <div class="stars">
                      <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                    </div><br>
                    <p>
                      <i class="bi bi-quote quote-icon-left"></i>
                      "Dengan sistem POS ini, saya bisa memantau semua pekerjaan perbaikan perangkat dengan lebih mudah dan efisien. Proses pembukuan juga lebih jelas."
                      <i class="bi bi-quote quote-icon-right"></i>
                    </p>
                  </div>
                </div>
              ...
              <div class="row g-4">
                <div class="col-lg-4 col-md-6" data-aos-delay="50">
                  <div class="testimonial-item">
                    ...
                    <p>
                      <i class="bi bi-quote quote-icon-left"></i>
                      "Sistem POS ini sangat memudahkan saya dalam mencatat semua pekerjaan yang sedang dikerjakan, mulai dari perbaikan perangkat hingga instalasi jaringan."
                      <i class="bi bi-quote quote-icon-right"></i>
                    </p>
                  </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos-delay="350">
                  <div class="testimonial-item">
                    ...
                    <p>
                      <i class="bi bi-quote quote-icon-left"></i>
                      "Penggunaan sistem POS ini sangat mempermudah pencatatan dan pengelolaan pendapatan dari layanan perbaikan dan instalasi jaringan. Proses jadi lebih cepat!"
                      <i class="bi bi-quote quote-icon-right"></i>
                    </p>
                  </div>
                </div>
