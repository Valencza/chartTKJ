                ...
                <div class="table-responsive">
                    <table class="table align-middle table-row-dashed fs-6 gy-5"
                        ...
                        <tbody class="fw-semibold text-gray-700">
                            @foreach ($kategoriProdukList as $index => $kategoriProduk)
                            <tr>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route ('kategoriProduk.store') }}" id="formTambahKategori" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @if (isset($kategoriProduk) && $kategoriProduk !== null)
                <form action="{{ route('kategoriProduk.update', ['id' => $kategoriProduk->id ?? '']) }}" method="POST" id="editKategoriForm" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="mb-3">
                        <label for="nama" class="form-label">Kategori Produk</label>
                        <input type="text" class="form-control" name="nama" id="nama" value="{{ old('nama', $kategoriProduk->nama) }}" required>
                    </div>
            ...
            button.addEventListener("click", function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '/dashboard/kategori-produk/' + kategoriId, // Gantilah dengan route yang benar
                            method: 'DELETE',
                            headers: {
